        ...
        <div className="info">
            ...
            <div className="slider">
                ...
                <div className="mypopup">
                    ...
                    <h4 style={{marginLeft:200,marginTop:10,marginBottom:20}}>Instructions</h4>
                    <div className="clearicon"><ClearIcon onClick={e=>setshow(false)} /></div>
                    </div>
                    
                    <ul className="popupinfo">
                        <li style={{marginBottom:15}}>We are not accepting orders as this is only for educational purpose</li>
